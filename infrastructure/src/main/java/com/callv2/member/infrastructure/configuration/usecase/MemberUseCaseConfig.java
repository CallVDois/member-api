...
import com.callv2.member.application.member.update.nickname.DefaultUpdateNicknameUseCase;
...
public class MemberUseCaseConfig {
    ...
    UpdateNicknameUseCase updateNicknameUseCase() {
        return new DefaultUpdateNicknameUseCase(memberGateway, eventDispatcher);
    }
